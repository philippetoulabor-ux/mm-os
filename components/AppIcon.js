...
/**
 * @param {{ app: { id: string; icon: string; iconSrc?: string }; variant?: "default" | "compact" }} props
 */
export function AppIcon({ app, variant = "default" }) {
  ...
  if (app.iconSrc) {
    ...
    return (
      <span
        className={`inline-flex overflow-hidden rounded-full ${sz} shrink-0 shadow-md ring-1 ring-black/10 dark:ring-white/15`}
        aria-hidden
      >
